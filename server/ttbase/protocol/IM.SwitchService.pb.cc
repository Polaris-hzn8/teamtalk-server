...
struct StaticDescriptorInitializer_IM_2eSwitchService_2eproto {
  StaticDescriptorInitializer_IM_2eSwitchService_2eproto() { protobuf_AddDesc_IM_2eSwitchService_2eproto(); }
...
IMP2PCmdMsg::IMP2PCmdMsg(const IMP2PCmdMsg& from) : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
...
#define OFFSET_OF_FIELD_(f) \
  (reinterpret_cast<char*>(&reinterpret_cast<IMP2PCmdMsg*>(16)->f) - reinterpret_cast<char*>(16))
...
bool IMP2PCmdMsg::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input) {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        if (tag == 26) {
        parse_cmd_msg_data:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(input, this->mutable_cmd_msg_data()));
        } else {
          goto handle_unusual;
        }
...
void IMP2PCmdMsg::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const {
  ...
  // required string cmd_msg_data = 3;
  if (has_cmd_msg_data()) {
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(3, this->cmd_msg_data(), output);
  }
...
int IMP2PCmdMsg::ByteSize() const {
  ...
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    // required string cmd_msg_data = 3;
    if (has_cmd_msg_data()) {
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->cmd_msg_data());
    }
  }
...
void IMP2PCmdMsg::CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from) {
