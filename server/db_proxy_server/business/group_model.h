...
class CGroupModel {
 ...
 public:
  uint32_t createGroup(uint32_t nUserId,
                       const std::string& strGroupName,
                       const std::string& strGroupAvatar,
                       uint32_t nGroupType,
  ...
  void getGroupInfo(std::map<uint32_t, IM::BaseDefine::GroupVersionInfo>& mapGroupId,
  ...
  bool modifyGroupMember(uint32_t nUserId,
                         uint32_t nGroupId,
 ...
 private:
  ...
  bool insertNewGroup(uint32_t reqUserId,
                      const std::string& groupName,
                      const std::string& groupAvatar,
                      uint32_t groupType,
                      uint32_t memCnt,
                      uint32_t& groupId);
