...
teamtalk-server使用了许多第三方库，包括protobuf、hiredis、mariadb(mysql)、log4cxx等等，

服务端对pb，hiredis，mysql_client，log4cxx有依赖，所以服务端需要先安装pb，hiredis，mysql，log4cxx等依赖，

可以自行安装或者执行auto目录下的shell脚本自动化安装，
