/*
 ...
 filename: DBPool.cpp
 Update Time: Thu 15 Jun 2023 01:03:26 CST
 brief:
*/
...
int CDBManager::Init() {
  ...
  for (uint32_t i = 0; i < instances_name.GetItemCnt(); i++) {
    ...
    std::string str_db_port = config_file.GetConfigValue(port);
    ...
    if (db_host.empty() || str_db_port.empty() || db_dbname.empty() || db_username.empty() || db_password.empty() ||
