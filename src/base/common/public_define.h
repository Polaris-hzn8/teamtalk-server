...
#define CHECK_MSG_TYPE_SINGLE(type)                        \
  ({                                                       \
    bool bRet = false;                                     \
    if ((IM::BaseDefine::MSG_TYPE_SINGLE_TEXT == type) ||  \
        (IM::BaseDefine::MSG_TYPE_SINGLE_AUDIO == type)) { \
      bRet = true;                                         \
    }                                                      \
    bRet;                                                  \
  })
...
#define CHECK_MSG_TYPE_GROUP(type)                        \
  ({                                                      \
    bool bRet = false;                                    \
    if ((IM::BaseDefine::MSG_TYPE_GROUP_TEXT == type) ||  \
        (IM::BaseDefine::MSG_TYPE_GROUP_AUDIO == type)) { \
      bRet = true;                                        \
    }                                                     \
    bRet;                                                 \
  })
